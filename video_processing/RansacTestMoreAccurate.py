...
spider_segment_combined = np.vstack((spider_segment, polynomialPred))
...
pcd.colors = o3d.utility.Vector3dVector(np.zeros((len(pcd.points), 3)))  # Set all points to black
...
render_option.point_size = 0.1  # Adjust point size (e.g., smaller than default, 1.0)
