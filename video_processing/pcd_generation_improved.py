...
if __name__ == '__main__':
    distance_data = pd.read_csv("video_processing/distance_records/@064 255 distance data 2024-12-10 17-49-41.csv")
    video_path = "video_processing/spider_videos/@064 255 2024-12-10 17-49-41.mp4"
